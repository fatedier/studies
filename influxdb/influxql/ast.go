...
// 返回 souce 的名字，如果是 measurement 的话
...
// 是否是系统内部资源，例如 measurement, tags 等
...
type SelectStatement struct {
	...
	// 获取数据的 数据库，存储策略，measurement
	Sources Sources

	// An expression evaluated on data point.
	// 匹配 Point 的参数，例如 time > now() - 1h and host_id='200'
	Condition Expr

...
#define TRACKER_STATUS_FILENAME			".tracker_status"			/* tracker server状态文件 */
#define TRACKER_STATUS_ITEM_UP_TIME		"up_time"				/* 启动时间参数名 */
#define TRACKER_STATUS_ITEM_LAST_CHECK_TIME	"last_check_time"		/* 最后一次检查时间参数名 */
...
{
	char full_filename[MAX_PATH_SIZE];	/* tracker状态文件 */

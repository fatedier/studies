...
// Points 中一个 key 对应的 value 对象
// 目前主要有5种
// EmptyValue, FloatValue, BooleanValue, IntegerValue, StringValue
type Value interface {
	UnixNano() int64		// 返回时间
	Value() interface{}		// 返回值
	Size() int				// value值所有占用的内存大小，包括时间
	String() string

	internalOnly()
}

// 创建一个 Value 对象，包括时间以及值

...
// 将一个正在运行中的查询任务附加到 TaskManager 来管理，可以通过 interrupt 通道来中断查询操作
// 查询任务的结束可以通过 QueryTask 的 close 通道获取
